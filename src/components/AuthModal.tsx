...
export default function AuthModal({ onClose, initialMode = 'login', upgradePrompt }: AuthModalProps) {
  ...
  const { signInWithEmail, signUpWithEmail, signInWithGoogle, resendVerificationEmail, resetPassword } = useAuth();
