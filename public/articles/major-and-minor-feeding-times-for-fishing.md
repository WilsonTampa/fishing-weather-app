...
> **Why Two Major Periods?** It's the same reason we get two high tides a day. The moon's gravity creates a pull on both the near side and far side of Earth. Your fishing spot feels both, roughly 12 hours apart. If you want the full breakdown on how this works, check out [How the Moon Affects Tides & Fishing](/learn/how-does-moon-affect-tides).
...
During new and full moons, the gravitational influence is at its peak. [Spring tides](/learn/how-does-moon-affect-tides) are running, water is moving more than usual, and the major/minor feeding windows tend to be at their most productive. If you're going to build your fishing schedule around solunar data, these are the days to prioritize.
...
A major period during a strong incoming or outgoing tide is the classic combination. The moon's position is triggering feeding behavior, and the current is delivering food right to the fish. This is the overlap that produces those insane bites where you're catching fish on every cast and wondering if this is even legal.
...
If tracking moon transit times and cross-referencing tide charts sounds like a lot of work, a fishing activity score can simplify things. [My Marine Forecast](https://mymarineforecast.com) calculates a 0-100 activity score for any day and location based on moon phase, feeding period timing, and whether those periods overlap with daylight hours and sunrise/sunset windows.
...
## Check Your Feeding Times

Check [My Marine Forecast](https://mymarineforecast.com) for today's major and minor feeding periods at your location, alongside tide charts, moon phase, barometric pressure, and a daily activity score — everything in one place so you can pick the best window and get out there.
